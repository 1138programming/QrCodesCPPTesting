...
static const bt::GUID MY_GUID = {0x0007EA11, 0x1138, 0x1000, {0x54, 0x65, 0x61, 0x6D, 0x31, 0x31, 0x33, 0x38}};//{0x00001101, 0x0000, 0x1000, {0x80, 0x00, 0x00, 0x80, 0x5f, 0x9b, 0x34, 0xfb}};
